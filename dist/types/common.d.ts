export declare const ANNOUNCEMENT_INTERVAL = 1000;
export declare const LISTEN_PORT = 51337;
export declare const LISTEN_TIMEOUT = 5000;
export declare const MESSAGE_TIMEOUT = 3000;
export declare const CONNECT_TIMEOUT = 5000;
export declare const DOWNLOAD_TIMEOUT = 60000;
export declare const DISCOVERY_MESSAGE_MARKER = "airD";
...
export declare enum StageLinqValue {
