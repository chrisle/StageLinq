...
export enum StageLinqValue {
  ...
  EngineDeck1TrackCurrentKey = '/Engine/Deck1/Track/CurrentKey',
  ...
  EngineDeck1TrackGenre = '/Engine/Deck1/Track/Genre',
  ...
  EngineDeck2TrackCurrentKey = '/Engine/Deck2/Track/CurrentKey',
  ...
  EngineDeck2TrackGenre = '/Engine/Deck2/Track/Genre',
  ...
  EngineDeck3TrackCurrentKey = '/Engine/Deck3/Track/CurrentKey',
  ...
  EngineDeck3TrackGenre = '/Engine/Deck3/Track/Genre',
  ...
  EngineDeck4TrackCurrentKey = '/Engine/Deck4/Track/CurrentKey',
  ...
  EngineDeck4TrackGenre = '/Engine/Deck4/Track/Genre',
